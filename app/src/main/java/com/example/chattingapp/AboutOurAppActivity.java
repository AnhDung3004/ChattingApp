...
public class AboutOurAppActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.txtThanksName.setText("Thank you (" + auth.getCurrentUser().getDisplayName() + ")");
        ...
        binding.txtPrivacyPolicy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(AboutOurAppActivity.this, "Our Privicy Policy is available on our website, let's take a look now", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        binding.txtNotification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(AboutOurAppActivity.this, "Don't miss our news, let's check notification on our website now", Toast.LENGTH_SHORT).show();
            }
        });
